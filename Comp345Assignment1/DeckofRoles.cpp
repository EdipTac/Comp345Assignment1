...
DeckofRoles::DeckofRoles() {
	...
	deckofRole.push_back(make_unique<RoleCard>("CONTINGENCY PLANNER", "The Contingency Planner may, as an action, take an"
	...
	deckofRole.push_back(make_unique<RoleCard>("DISPATCHER","The Dispatcher may, as an action, either:\n"
	...
	deckofRole.push_back(make_unique<RoleCard>("MEDIC", "The Medic removes ALL cubes, not 1, of the same color"
	...
	deckofRole.push_back(make_unique<RoleCard>("OPERATIONS EXPERT","The Operations Expert man, as an action, either\n"
	...
	deckofRole.push_back(make_unique<RoleCard>("QUARANTINE SPECIALIST", "The Quarantine Specialist prevents both outbreaks and "
	...
	deckofRole.push_back(make_unique<RoleCard>("RESEARCHER", "As an action, the Researcher may give any City card from "
	...
	deckofRole.push_back(make_unique<RoleCard>("SCIENTIST","The Scientist needs only 4 (not 5) City cards of "
